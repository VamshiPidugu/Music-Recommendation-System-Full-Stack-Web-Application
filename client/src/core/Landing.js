...
const Landing = () => {
	return (
		<Base>
			<section className="" style={{ background: "#89cff0" }}>
				<div class="svgs">
				...
				<div className="page" id="part1">
					...
					<div className="info">
						<div className="title text-primary" ><div style={{color: "black"}}>Music Recommender System</div></div>
						<div className="title-support">using Collaborative Filtering  </div>
						<div className="dev">
